# Embedded file name: /home/oe1/atv64arm/build-enviroment/builds/openatv/release/hd60/tmp/work/cortexa15hf-neon-vfpv4-oe-linux-gnueabi/enigma2-plugin-skins-madmax-impossible/1.6+gitAUTOINC+1b553b6778-r0/git/MadMax-Impossible-Skin/usr/lib/enigma2/python/Components/Converter/MMTemp.py
            ...
            try:
                if os.path.exists('/proc/stb/sensors/temp0/value'):
                    with open('/proc/stb/sensors/temp0/value') as stemp:
                        systemp = '%s\xc2\xb0C' % stemp.readline().replace('\n', '')
                ...
                if os.path.exists('/proc/stb/fp/temp_sensor_avs'):
                    with open('/proc/stb/fp/temp_sensor_avs') as ctemp:
                        cputemp = '%s\xc2\xb0C' % ctemp.readline().replace('\n', '')
                    ...
                    with open('/sys/devices/virtual/thermal/thermal_zone0/temp') as ctemp:
                        cputemp = '%s\xc2\xb0C' % ctemp.read()[:2].replace('\n', '')
